...
■ Q-121.이름과 연봉(sal*12)를 출력하는데 연봉을 출력할때 (3,000)형식으로 되게 하시오.
...
■ Q-137. 전공을 출력하고 전공별 평균나이 출력하는데 전공이 ㄱ,ㄴ,ㄷ 순으로 출력되게 하시오! 
...
■ Q-159. 이메일 도메인,이름,나이,순위를 출력하는데 순위가 이메일 도메인 별로 각각 나이가 높은 학생순으로 출력되게 하시오.  
